# ESLint & TypeScript Configuration Reference for OCMUI Bugfix Workflow

This document extracts key rules from the uhc-portal linting configs to prevent common errors during automated bugfix workflows.
...
### 1. Import Order (simple-import-sort/imports)

**Rule:** Lines 103-123 in `.eslintrc`
...
```bash
# Read ESLint config to understand rules
cat /workspace/repos/uhc-portal/.eslintrc | jq '.rules."simple-import-sort/imports"'

# Verify code follows import order
yarn lint
...
# Common auto-fixes
yarn lint --fix  # Fixes import order automatically
```
...
**ESLint Config:** `/workspace/repos/uhc-portal/.eslintrc`
- Line 103-123: Import order rules
- Line 92-101: Testing Library rules
- Line 61: React hooks exhaustive deps

**TypeScript Config:** `/workspace/repos/uhc-portal/tsconfig.json`
- Line 17: `strict: true`
- Line 13: `noUnusedLocals: true`
- Line 18-20: Path alias configuration

**TypeScript Lint Config:** `/workspace/repos/uhc-portal/tsconfig.lint.json`
- Extends main tsconfig.json
- Includes all .js, .jsx, .ts, .tsx, .mjs files

---

*Reference guide created 2026-04-02 based on uhc-portal configs*
